package com.fanfan.hotel.utils.gif;
...
public class FaceData {
    ...
    static {
        ...
        addString(gifFaceInfo, f37, R.mipmap.f37);
        addString(gifFaceInfo, f38, R.mipmap.f38);
        addString(gifFaceInfo, f39, R.mipmap.f39);
        addString(gifFaceInfo, f40, R.mipmap.f40);
    }

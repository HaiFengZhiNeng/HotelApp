...
public class ChatPresenter extends IChatPresenter implements Observer {
    ...
    public void createGroupParam(String roomId) {
        TIMGroupManager.CreateGroupParam param = TIMGroupManager.getInstanceById(UserManage.getInstance().getControlName()).new CreateGroupParam();
...
//                robotBean.setOrder(Constants.PROJECT_PATH + fileElem.getFileName());
...
//                    Print.e(conversation.getPeer());
                ...
                } else if (msg == null || msg.getConversation().getPeer().equals(UserManage.roomAVId)
